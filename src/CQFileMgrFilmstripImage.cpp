...
contextMenuEvent(QContextMenuEvent *event)
{
  ...
  if (! showImagesAction) {
    ...
    connect(iconsAction, SIGNAL(triggered()),
            this, SLOT(iconsView()));
    connect(detailsAction, SIGNAL(triggered()),
            this, SLOT(detailsView()));
    connect(showImagesAction, SIGNAL(toggled(bool)),
            this, SLOT(showImages(bool)));
    connect(smallIconsAction, SIGNAL(toggled(bool)),
            this, SLOT(smallIcons(bool)));
